...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationName("Infinitecoin");
    QApplication::setOrganizationDomain("ifc123.net");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("Infinitecoin-Qt-testnet");
    else
        QApplication::setApplicationName("Infinitecoin-Qt");
